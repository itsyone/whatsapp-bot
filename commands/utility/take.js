...
async function takeCommand(sock, chatId, message, args) {
    try {
        ...
        const packname = args.join(' ') || 'Eclipse';
...
module.exports = {
  name: 'take',
  async execute(ctx) {
    return takeCommand(ctx.sock || null, ctx.chatId || null, ctx.message || null, ctx.args || null);
  }
};
