...
module.exports.name = 'anticall';
module.exports.permissionLevel = 'sudo'; // FIXED: central sudo permission
module.exports.execute = async function execute(ctx) {
    return anticallCommand(ctx.sock || null, ctx.chatId || null, ctx.message || null, ctx.args || '');
};
