const { loadUserGroupData, setAntiBadword, getAntiBadword, removeAntiBadword, incrementWarningCount, resetWarningCount } = require('../lib/index');
const fs = require('fs');
...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId, adminStatus = {}) {
